...
# Function to create to visualazations
    ...
    with st.form(key='add_book_form'):
        ...
        with col2:
            genre = st.selectbox("Genre", [
                ...
                "Self-Help", "Poetry", "Science","Philosophy",
                "Religion", "Art", "Other
            ])
...
# Footer
st.markdown("---")
st.markdown("Copyright @ 2025 Zeeshan Haider Personal Library Manager", unsafe_allow_html=True)
